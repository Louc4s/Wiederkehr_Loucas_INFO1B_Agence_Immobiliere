...
from APP_AGENCE_164.erreurs.msg_erreurs import *
from APP_AGENCE_164.essais_wtf_forms.wtf_forms_demo_select import DemoFormSelectWTF
    ...
    try:
        ...
        if request.method == "GET":
            with DBconnection() as mc_afficher:
                ...
                strsql_genres_afficher = """SELECT * FROM t_biens ORDER BY id_biens ASC"""
            ...
            for i in data_genres:
                ...
                genre_val_list_dropdown.append(i['id_biens'])
